...
function Footer() {
  return (
    <footer className="w-full border-t ml-4 lg:ml-0">
      <div className="container mx-auto pt-8 lg:py-6">
        <section className="flex flex-col lg:flex-row gap-10 lg:gap-20">
          ...
          <section className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6">
          ...
          <section className="space-y-3">
            <h4 className="font-medium">Subscribe to our newLetter</h4>
            <NewsLetterForm />
          </section>
        </section>
      </div>
